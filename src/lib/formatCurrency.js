// src/hooks/useFormatCurrency.js (or src/currency/useFormatCurrency.js)
// Make sure this file is client-side rendered if it's used in components
// that are not explicitly marked as 'use client'
'use client'; // Add this directive if it's not already covered by a parent component

import { useContext } from 'react';
import { CurrencyContext } from '@/context/CurrencyContext'; // Correct path

// Rename the function to start with 'use' to make it a custom hook
const useFormatCurrency = () => {
  ...
  // Return the actual formatting function from the hook
  ...
  return formatCurrency; // This hook returns the actual formatting function
};
